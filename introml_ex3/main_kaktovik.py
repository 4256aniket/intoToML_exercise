...
img1 = cv2.imread('introml_ex3/img/kaktovik-008_rot_0.jpg', cv2.IMREAD_GRAYSCALE)
img2 = cv2.imread('introml_ex3/solution/img/kaktovik-012_rot_0.jpg', cv2.IMREAD_GRAYSCALE)
img3 = cv2.imread('introml_ex3/solution/img/kaktovik-012_rot_2.jpg', cv2.IMREAD_GRAYSCALE)
